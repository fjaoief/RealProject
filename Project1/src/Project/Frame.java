...
public class Frame {
   ...
   public void detailStat1() {
      ...
      mainTextArea.setText("체력: 얼마나 오래 살 수 있는지 알려줍니다. 0으로 떨어지면 죽습니다.\r\n"
   ...
   public void detailStat2() {
      ...
      mainTextArea.setText("지력: 캐릭터의 두개골이 머리인지 뚝배기인지 알려줍니다. 마법데미지가 증가합니다.\r\n"
   ...
   */
   ...
   public void ending() {
      ...
      choice1.setText("다시하기.");
      choice2.setText("그만하기.");
      choice3.setText("");
      choice4.setText("");
      choice1.setVisible(true);
      choice2.setVisible(true);
